...
void Sphere::Initialize(DirectXCommon* directXCommon, YTEngine* engine, const DirectionalLight& light) {
...
void Sphere::CreateDirectionalLight(const DirectionalLight& light) {
